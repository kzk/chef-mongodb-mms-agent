...
NOTE: This chef recipe installs only the agent program, not MongoDB itself. edelight's great {MongoDB recipe}[https://github.com/edelight/chef-cookbooks] is recommended.
